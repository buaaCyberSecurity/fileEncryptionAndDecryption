...
int main()
{
    ...
    serv_addr.sin_addr.s_addr = inet_addr("192.168.43.52");  //ip address
    ...
    RSA EncryptRsa = d2i_RSAPublicKey(PKey, (int)(pk_len));
    ...
    int l = 0;
    RSA_public_encrypt(seed, outseed, l);
    printf("The seed is %s\n\n\n\n\n", seed);
    //send encrypted seed
    sendSeed(outseed,SEED_LEN << 2,sock);
